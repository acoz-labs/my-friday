...
| User text limits | Length limits count user-perceived grapheme clusters; name/address cap at 60 and purpose/custom guidance at 240. | Combining characters and emoji should behave as one visible character, and the approved profile surface stays bounded. |
