...
builder description, and skill file are model-visible and that any reported
skill-root alias resolves to the instance's exact private workspace skill root.
