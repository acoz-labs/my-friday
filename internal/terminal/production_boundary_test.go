...
func TestProductionNetworkAndSubprocessBoundary(t *testing.T) {
	...
	allowedImports := map[string]bool{
		...
		"errors": true, "fmt": true, "io": true, "io/fs": true, "os": true, "os/exec": true, "os/signal": true, "os/user": true, "path/filepath": true,
		...
		"github.com/acoz-labs/my-friday/internal/assistantinstance":  true,
		"github.com/acoz-labs/my-friday/internal/capability":         true,
		"github.com/acoz-labs/my-friday/internal/capabilityworkshop": true,
